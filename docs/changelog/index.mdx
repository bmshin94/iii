...
<Update label="0.24.0" description="September 2026">
  ...
  - Node: no API change. Drop any pnpm patch or override that forced `@opentelemetry/*` 2.x on top of `@iii-dev/helpers` 0.23.
</Update>
